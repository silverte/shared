...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    for cert in certificates:
        ...
        if cert_details.get('Type') == 'IMPORTED':
            evaluations.append(build_evaluation(cert_arn, 'NOT_APPLICABLE', event, annotation='Imported certificate'))
        elif cert_details.get('Options', {}).get('CertificateTransparencyLoggingPreference') == 'ENABLED':
